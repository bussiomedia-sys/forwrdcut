...
- Open a loop the viewer needs closed: a question, a curiosity gap, a contrarian claim, a
  pattern interrupt ("Most weekender bags are an afterthought. These two aren't.").
...
- **Curiosity gap:** "Wait… is that a carry-on or a backpack?" (answer withheld 1–2 beats)
