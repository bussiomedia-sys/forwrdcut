...
# Pronunciation lexicon: respell out-of-dictionary / brand words so the TTS G2P says
# them correctly. Add your own brand/product spellings here (or drive them from a brand
# kit). Captions are unaffected — they come from Whisper transcribing the spoken audio.
_LEXICON = {
    r"\bforwrd\b": "forward",   # so the tool's own name ("ForwrdCut") is spoken correctly
}
